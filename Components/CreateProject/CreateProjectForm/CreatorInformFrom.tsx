    ...
    return (
        <div className ="h-fit bg-slate-100">
            ...
            <div className ="w-96 my-14">
                ...
                <p className ="my-2 text-gray-600">크리에이터 혹은 크리에티 팀의 이름을 작성해주세요.</p>
                <input 
            ...
            <div className ="w-[34rem] my-14">
                ...
                <p className ="my-2 text-gray-600">크리에이터 혹은 크리에티 팀의 소개 글을 작성해주세요..</p>
                <input 
            ...
            <div className ="w-96 my-14">
                ...
                <p className ="my-2 text-gray-600">대표자 본인 명의의 세금 계산서를 발행해주세요.</p>
                <input 
                    className={`rounded-sm w-96 h-12 border-[0.1rem] ${getInputBorderColor(taxbill,40)} text-start`}
