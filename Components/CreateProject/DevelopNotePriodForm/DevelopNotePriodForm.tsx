              ...
              <button className="flex">
                <p
                  ...
                  className={`font-semibold ${
                    selectedWeek === item ? "text-[#685BFE]" : "text-gray-300"
                  }`}
                ...
                <p
                  className={`${
                    selectedWeek === item ? "text-black" : "text-gray-300"
                  }`}
                >
                  {unit}
                </p>
  ...
  return (
    <div className="mt-[6rem]">
      ...
      <p className="text-[0.8rem]">
        개발노트의 업로드 주기를 설정해주세요. <br /> 개발노트를 꾸준히 올리면
        평가가 점점 좋아집니다!
      </p>

      <h2 className="font-semibold text-lg mt-12">주기 설정</h2>
      <p className="my-2 text-gray-500 text-[0.9rem]">
        몇주 주기로 무슨 요일에 개발 노트를 업로드를 할지 설정하세요!
      </p>
        ...
        <div className="w-[20rem] h-fit border-2 border-slate-300 bg-white">
          <div className="flex justify-between h-fit my-[0.2rem]">
            <div className="flex h-fit px-4 py-3 gap-2">
              ...
              <p className="text-[0.8rem]">
                개발일지의 업로드 일자를 놓칠때마다, 펀딩금액에 영향이 갈 수
                있습니다.
              </p>
            </div>
          </div>
      ...
      <div className="relative w-fit">
        ...
        <div className="absolute w-fit left-10 top-4">
          ...
          <p className="text-[0.8rem] text-gray-400 my-4">
            2주마다 월요일에 업로드 예정
          </p>
          <p className="text-purple-900 text-sm mx-auto my-7">
            다음 업로드 예정일 : 11월 6일
          </p>
        </div>
