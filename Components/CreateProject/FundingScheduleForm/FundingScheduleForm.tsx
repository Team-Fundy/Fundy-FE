  ...
  return (
    <div className="h-fit bg-slate-100 mx-[8rem]">
      ...
      <div className="w-96 my-14">
        ...
        <p className="my-2 text-gray-600 text-[0.9rem]">
        ...
        <div className="relative w-fit">
          ...
          />
          <p className="absolute bottom-3 right-3 font-semibold text-[1.1rem]">
            원
          </p>
        </div>
        ...
        <div className="border-2 border-slate-200 w-[40rem] mt-4 h-fit text-gray-500 px-6 py-4 bg-white">
          ...
          <ul className="list-disc ml-10">
            ...
            <li>
              {" "}
              프로젝트의 성공 여부를 결정짓는 중요한 요소이니 신중하게 고민해
              주세요.
            </li>
            <li>
              {" "}
              펀디는 후원자들의 후원금을 바로 받을 수 없습니다.
              <br />
              펀딩일이 끝나는 날에 후원자들의 전체 후원금을 받을 수 있다는 것을
              명심해주세요.
            </li>
          </ul>
        </div>
