...
export default function ProjectInformForm() {
  const [isOpenSelectGenreOption, setIsOpenSelectGenreOption] =
  ...
  return (
    <div className="h-fit bg-slate-100">
      <h1 className="my-3 font-bold text-4xl">프로젝트 정보 작성</h1>
      ...
      <div className="w-96 my-14">
        ...
        <p className="my-2 text-gray-600">
          게임 프로젝트의 게임 카테고리를 설정해주세요. <br /> 지금 설정했어도
          이후에 바꿀 수 있어요
        </p>
        {!isOpenSelectGenreOption ? (
          <button className="w-96 h-12 bg-white border-2 border-slate-200 flex justify-between">
            <p
              className={`mx-4 my-auto overflow-hidden text-ellipsis ${
                selectedGenre.length > 0 ? "text-slate-600" : "text-slate-200"
              }`}
            >
            ...
            <p
              ...
              onClick={() => setIsOpenSelectGenreOption(true)}
            >
              내리기
            </p>
          </button>
          ...
          <ProjectCategory
            ...
            setIsOpenSelectGenreOption={setIsOpenSelectGenreOption}
          />
        )}
      </div>
      <hr />
      ...
      <div className="w-96 my-14">
        ...
        <p className="my-2 text-gray-600">
          프로젝트 게임을 대표할 수 있는 멋있는 이름을 지어주세요.
        </p>
        <input
      ...
      <div className="w-[34rem] my-14">
        ...
        <p className="my-2 text-gray-600">
          프로젝트 게임의 내용을 펀더들이 이해하고 펀딩할 수 있도록 간략하고
          명확하게 설명해주세요.
        </p>
        <input
      ...
      <p className="my-2 text-gray-600">
        펀더들이 한눈 프로젝트의 느낌을 알 수 있도록 메인 이미지를 업로드
        해주세요.
      </p>
      <div className="flex gap-2">
        ...
        >
          <Image
            src={profileImage != null ? profileImage : imageUploadButton}
            alt="nll"
            width={120}
            height={170}
          />
            ...
            <div>
              ...
              <div className="flex gap-1">
                ...
                <p className="text-gray-500">
                  {" "}
                  최소 (가로 1240px, 세로 930px 이상) <br /> 최대 (가로 1920px,
                  세로 1080px 이하)
                </p>
              </div>
            </div>
